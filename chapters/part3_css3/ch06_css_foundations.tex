...
\begin{codeWindow}[Ví Dụ 4: Tạo Mũi Tên Tam Giác CSS Bằng Từ Khóa transparent]
\begin{lstlisting}[language=CSS3]
/* Tao hinh tam giac huong sang phai */
.arrow-right {
  width: 0;
  height: 0;
  border-top: 10px solid transparent;    /* Vien tren trong suot */
  border-bottom: 10px solid transparent; /* Vien duoi trong suot */
  border-left: 15px solid #007bff;       /* Vien trai co mau tao thanh mui ten */
}
\end{lstlisting}
\end{codeWindow}

\begin{codeWindow}[Ví Dụ 5: Đồng Bộ Màu Khung Nhập Liệu Input \& Icon SVG Khi Focus-within]
\begin{lstlisting}[language=HTML5]
<!-- Form Group Structure -->
<div class="input-group">
  <svg class="icon" fill="currentColor" viewBox="0 0 24 24"><path d="..."/></svg>
...
<style>
.input-group {
  color: #64748b; /* Mau icon va text phu mac dinh xam */
  border: 2px solid currentColor; /* Vien tu dong xam theo color */
  padding: 8px 12px;
  border-radius: 6px;
  transition: color 0.3s ease;
}

/* Khi nguoi dung Focus vao o input ben trong */
.input-group:focus-within {
  color: #2563eb; /* Ca vien va Icon SVG tu dong doi sang xanh duong! */
}
</style>
\end{lstlisting}
\end{codeWindow}

\begin{browserWindow}[Kết Quả Hiển Thị Mũi Tên Tam Giác (transparent) \& Form Input Focus (currentColor)]
\vspace{2pt}
\begin{tcolorbox}[
    enhanced,
    colback=white,
  ...
  % CSS Triangle Arrow Preview
  {\sffamily\bfseries\color{primaryBlue} Mũi Tên Tam Giác Tạo Từ \codeinline{transparent}}:\\[4pt]
  \begin{tcolorbox}[nobeforeafter, colback=blue!10, colframe=blue!60, arc=2pt, boxrule=0.4pt, top=3pt, bottom=3pt, left=8pt, right=8pt, fontupper=\sffamily\bfseries\small\color{blue!80!black}]
    Mũi tên hướng phải \quad $\rightarrow$ \quad (\codeinline{border-top/bottom: transparent;})
  \end{tcolorbox}
  \vspace{6pt}
  
  % Input Focus Sync Preview
  {\sffamily\bfseries\color{primaryBlue} Trạng Thái Focus Input Đồng Bộ Icon SVG Với \codeinline{currentColor}}:\\[4pt]
  \begin{tcolorbox}[
      enhanced,
      colback=blue!5,
    ...
    [Icon SVG xanh] \quad Nhập họ tên... \quad (\codeinline{border} và Icon tự động đổi màu Xanh dương khi Focus)
  \end{tcolorbox}
\end{tcolorbox}
\end{browserWindow}
