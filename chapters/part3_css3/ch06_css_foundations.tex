...
\begin{tikzpicture}[scale=0.95, transform shape]
  % Box 1: Text đỏ trên nền xanh lá
  \fill[green!80!black] (0, 1.2) rectangle (9, 2.2);
  \node[font=\sffamily\bfseries\color{red}] at (4.5, 1.7) {.basic-text: Chữ màu Đỏ rgb(255,0,0) trên nền Xanh lá rgb(0,255,0)};
  
  % Box 2: Translucent box trên nền văn bản bên dưới
  \node[font=\sffamily\small\color{gray}] at (4.5, 0.4) {Dòng văn bản phía dưới nằm dưới lớp phủ RGBA...};
  \fill[blue, fill opacity=0.5] (0.5, 0.0) rectangle (8.5, 0.8);
  \node[font=\sffamily\bfseries\color{white}] at (4.5, 0.4) {.translucent-box: Nền Xanh dương mờ 50\% rgba(0,0,255,0.5)};
\end{tikzpicture}
\end{center}
\end{browserWindow}
...
\begin{center}
\begin{tikzpicture}[scale=0.9, transform shape]
  % Error Note Box Preview
  \fill[red!10] (-0.5, 1.5) rectangle (10.5, 2.7);
  \draw[red, thick] (-0.5, 1.5) rectangle (10.5, 2.7);
  \node[font=\sffamily\bfseries\color{red!80!black}] at (5, 2.1) {.note: Thông báo lỗi hệ thống (Nền rgba(255,0,0,0.1), Viền rgb(255,0,0))};
  
  % Linear Gradient Preview
  \shade[left color=red!60, right color=blue!60] (-0.5, -0.2) rectangle (10.5, 1.0);
  \node[font=\sffamily\bfseries\color{white}] at (5, 0.4) {.gradient-banner: linear-gradient(to right, rgba(255,0,0,0.5), rgba(0,0,255,0.5))};
\end{tikzpicture}
\end{center}
\end{browserWindow}
