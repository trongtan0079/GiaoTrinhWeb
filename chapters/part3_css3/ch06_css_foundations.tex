...
\begin{tcolorbox}[
  ...
  \begin{center}
    ...
    \begin{tcolorbox}[colback=blue!4, colframe=blue!30, arc=4pt, boxrule=0.6pt, top=6pt, bottom=6pt, left=10pt, right=10pt]
      {\sffamily\Large\bfseries AaBbCc} \quad $\rightarrow$ \quad \textcolor{gray!60!black}{Sans-serif font: Nét phẳng, gọn gàng trên màn hình}\\[4pt]
      {\rmfamily\Large\bfseries AaBbCc} \quad $\rightarrow$ \quad \textcolor{gray!60!black}{Serif font: Nét gạch chân cổ điển, trang trọng}\\[4pt]
      {\rmfamily\Large\bfseries\color{red!80!black} AaBbCc} \quad $\rightarrow$ \quad \textcolor{red!80!black}{Serif font (red serifs): Vùng chân chữ (serifs) tô đỏ để nhận diện}
    \end{tcolorbox}
  \end{center}
\end{tcolorbox}
\end{browserWindow}
