...
Hệ màu RGB khai báo giá trị số thập phân từ $0$ đến $255$ cho 3 kênh màu đỏ, xanh lá và xanh dương. Biến thể \textbf{RGBA} bổ sung thêm kênh \textbf{Alpha} đại diện cho độ trong suốt (nhận giá trị từ \codeinline{0.0} -- hoàn toàn trong suốt đến \codeinline{1.0} -- đặc hoàn toàn).

\begin{codeWindow}[Ví Dụ Khai Báo Màu RGB \& RGBA]
\begin{lstlisting}[language=CSS3]
/* Mau do dac 100% */
.header-text {
  color: rgb(255, 0, 0);
...
/* Khoi nen den trong suot 70% (Overlay) */
.modal-overlay {
  background-color: rgba(0, 0, 0, 0.7);
}

/* Nut bam voi hieu ung mờ nhe khi hover */
.button-primary {
