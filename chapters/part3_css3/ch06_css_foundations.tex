...
\begin{browserWindow}[Kết Quả Hiển Thị Trực Quan 3 Khối Box Mờ Trình Duyệt]
\sffamily\small
\begin{center}
\setlength{\tabcolsep}{12pt}
\begin{tabular}{c c c}
\textbf{Box 1 (Khối Đỏ)} & \textbf{Box 2 (Khối Xanh Dương)} & \textbf{Box 3 (Khối Xanh Lá)} \\[2pt]
{\scriptsize\codeinline{opacity: 1;}} & {\scriptsize\codeinline{opacity: 0.5;}} & {\scriptsize\codeinline{opacity: 0.2;}} \\[6pt]
\fcolorbox{red!90!black}{red!90!black}{\parbox[c][35pt][c]{70pt}{\centering\color{white}\bfseries Opacity 1.0}} &
\fcolorbox{blue!90!black}{blue!50!white}{\parbox[c][35pt][c]{70pt}{\centering\color{white}\bfseries Opacity 0.5}} &
\fcolorbox{green!60!black}{green!20!white}{\parbox[c][35pt][c]{70pt}{\centering\color{gray!80!black}\bfseries Opacity 0.2}} \\[6pt]
\textcolor{green!60!black}{\textbf{Hiển thị 100\% (Không mờ)}} & \textcolor{primaryBlue}{\textbf{Mờ 50\% (Xuyên thấu)}} & \textcolor{red!80!black}{\textbf{Mờ 80\% (Rất mờ)}}
\end{tabular}
\end{center}
\end{browserWindow}
...
\rowcolors{2}{white}{primaryBlue!4}
\sffamily\small
\begin{tabularx}{\linewidth}{|>{\bfseries\color{primaryBlue}}p{3.2cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
\hline
