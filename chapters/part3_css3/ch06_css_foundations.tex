...
\hline
color: initial & \textcolor{red!80!black}{\textbf{Không}} & Reset màu chữ về mặc định của trình duyệt (thường là đen \codeinline{\#000000}). \\
\hline
\end{tabularx}
\end{prettyTableBox}

% ==========================================
% PHẦN 3.7: NHÓM PHÔNG CHỮ TỔNG QUÁT (GENERIC FONT FAMILIES MASTERCLASS)
% ==========================================
\paragraph{3.7. Nhóm Phông Chữ Tổng Quát Trong CSS (Generic Font Families Masterclass):}
...
\begin{browserWindow}[Minh Họa Trực Quan Sự Khác Biệt Giữa Serif (Có Chân) Và Sans-serif (Không Chân)]
\vspace{2pt}
\begin{tcolorbox}[
    enhanced,
    colback=white,
  ...
  \begin{center}
    {\sffamily\bfseries\Large\color{primaryBlue} Phân Biệt Nét Chân Chữ (Serifs) Trực Quan}\\[8pt]
    
    % Visual Comparison Box
    \begin{tcolorbox}[nobeforeafter, colback=gray!5, colframe=gray!30, arc=4pt, boxrule=0.6pt, top=6pt, bottom=6pt, left=10pt, right=10pt]
      \begin{tabular}{c c c}
        {\sffamily\Huge\bfseries F} & \quad {\rmfamily\Huge\bfseries F} \quad & {\rmfamily\Huge\bfseries\color{red!80!black} F} \\
        {\sffamily\small\bfseries Sans-serif (Không chân)} & \quad {\rmfamily\small\bfseries Serif (Có chân)} \quad & {\rmfamily\small\bfseries\color{red!80!black} Red Serifs (Chân đỏ)} \\
      \end{tabular}
    \end{tcolorbox}
    \vspace{6pt}
    
    % Sample Letters Box
    \begin{tcolorbox}[colback=blue!4, colframe=blue!30, arc=4pt, boxrule=0.6pt, top=6pt, bottom=6pt, left=10pt, right=10pt]
      {\sffamily\Large\bfseries AaBbCc} \quad $\rightarrow$ \quad \textcolor{gray!60!black}{Sans-serif: Nét phẳng, gọn gàng trên màn hình}\\[4pt]
      {\rmfamily\Large\bfseries AaBbCc} \quad $\rightarrow$ \quad \textcolor{gray!60!black}{Serif: Nét gạch chân cổ điển, trang trọng}
    \end{tcolorbox}
  \end{center}
\end{tcolorbox}
\end{browserWindow}
...
\hline
\multirow{3}{*}{\textbf{Serif (Có chân)}} & Times New Roman & Cổ điển, trang trọng (dùng nhiều trong báo chí, tài liệu in). \\
...
\hline
\multirow{5}{*}{\textbf{Sans-serif (Không chân)}} & Arial & Đơn giản, phổ biến nhất thế giới trên mọi hệ điều hành. \\
...
\hline
\multirow{2}{*}{\textbf{Monospace (Rộng đều)}} & Courier New & Phong cách máy đánh chữ cổ điển truyền thống. \\
 & Consolas & Font chuẩn mực khi viết mã nguồn code, gọn gàng dễ đọc. \\
\hline
\multirow{2}{*}{\textbf{Cursive (Viết tay)}} & Pacifico & Nét chữ viết tay đáng yêu, hợp cho tiêu đề nghệ thuật hoặc Logo. \\
 & Dancing Script & Nét chữ uyển chuyển, trang nhã cho thiệp mừng / banner. \\
\hline
\multirow{3}{*}{\textbf{Fantasy (Cách điệu)}} & Impact & Nét chữ cực đậm, thu hút sự chú ý ngay lập tức cho tiêu đề. \\
