...
\paragraph{2. Ứng Dụng Độc Đáo Của vmin: Tạo Khối Vuông Responsive Trên Mọi Thiết Bị:}

Khi sử dụng \codeinline{vmin}, một khối vuông có kích thước \codeinline{width: 40vmin; height: 40vmin;} sẽ luôn luôn vừa vặn hoàn hảo trong màn hình mà không bao giờ bị tràn cạnh, bất kể người dùng xoay ngang hay xoay dọc điện thoại.

\begin{codeWindow}[Tạo Khối Vuông Tự Co Giãn Thông Minh Bằng vmin]
\begin{lstlisting}[language=CSS3]
.responsive-square {
  width: 40vmin;   /* Tu dong lay 40% cua chieu nho nhat tren man hinh */
  height: 40vmin;
...
\begin{browserWindow}[Mô Phỏng Trực Quan Khối Vuông 40vmin Co Giãn Theo Chiều Nhỏ Nhất Của Màn Hình]
\sffamily\small
\centering
\begin{tcolorbox}[enhanced, colback=purple!80!black, colframe=purple!95!black, width=90pt, height=90pt, arc=8pt, boxrule=1pt, top=16pt, bottom=16pt, left=6pt, right=6pt]
  \centering
  \color{white}\bfseries\small Khối Vuông\par
  \scriptsize 40vmin $\times$ 40vmin
\end{tcolorbox}
\vspace{2pt}
\textcolor{primaryBlue}{\scriptsize ($\rightarrow$ Luôn giữ đúng tỷ lệ hình vuông $1:1$ hoàn mỹ trên cả màn hình dọc Portrait và ngang Landscape).}
\end{browserWindow}
