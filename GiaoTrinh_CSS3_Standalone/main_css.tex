...
\begin{browserWindow}[Mô Phỏng Trực Quan Trường Hợp 1: height: 50\% Bị Co Theo Nội Dung]
\sffamily\small
\centering
\begin{tcolorbox}[enhanced, colback=gray!20, colframe=gray!45, width=260pt, arc=5pt, boxrule=1pt, top=6pt, bottom=6pt, left=8pt, right=8pt]
  \textcolor{darkText}{\textbf{.parent (Không set height)}}\par\vspace{3pt}
  \begin{tcolorbox}[colback=pink!60, colframe=pink!90!black, arc=3pt, boxrule=0.8pt, top=3pt, bottom=3pt, left=6pt, right=6pt]
    \textcolor{purple!90!black}{\bfseries .child (height: 50\% $\rightarrow$ Chỉ ôm khít chữ "Hello")}
  \end{tcolorbox}
\end{tcolorbox}
\vspace{2pt}
\textcolor{accentOrange}{\scriptsize ($\rightarrow$ Kết quả: .child không đạt $50\%$ chiều cao mong muốn vì .parent không có chiều cao xác định).}
\end{browserWindow}
...
\begin{browserWindow}[Mô Phỏng Trực Quan Trường Hợp 2: height: 50\% Đạt Chuẩn 200px]
\sffamily\small
\centering
\begin{tcolorbox}[enhanced, colback=gray!20, colframe=gray!45, width=260pt, height=90pt, arc=5pt, boxrule=1pt, top=6pt, bottom=6pt, left=8pt, right=8pt]
  \textcolor{darkText}{\textbf{.parent (height: $400\text{px}$)}}\par\vspace{3pt}
  \begin{tcolorbox}[colback=pink!60, colframe=pink!90!black, height=45pt, arc=3pt, boxrule=0.8pt, top=4pt, bottom=4pt, left=6pt, right=6pt]
    \textcolor{purple!90!black}{\bfseries .child (height: 50\% $= 200\text{px}$ chuẩn xác)}
  \end{tcolorbox}
\end{tcolorbox}
\vspace{2pt}
\textcolor{primaryBlue}{\scriptsize ($\rightarrow$ Kết quả: .child chiếm chính xác một nửa chiều cao của khối cha $400\text{px}$).}
\end{browserWindow}
...
\begin{browserWindow}[Mô Phỏng Trực Quan Kết Quả: .child Chiếm Toàn Bộ Chiều Cao Màn Hình]
\sffamily\small
\centering
\begin{tcolorbox}[enhanced, colback=pink!50, colframe=purple!70!black, width=270pt, height=80pt, arc=6pt, boxrule=1.2pt, top=14pt, bottom=14pt, left=12pt, right=12pt]
  \centering
  \textcolor{purple!90!black}{\bfseries KHỐI .child PHỦ KÍN $100\%$ CHIỀU CAO MÀN HÌNH}\par\vspace{4pt}
  \textcolor{darkText}{\footnotesize (Nhờ thẻ \codeinline{html} và \codeinline{body} đều được thiết lập \codeinline{height: 100\%}).}
\end{tcolorbox}
\end{browserWindow}
