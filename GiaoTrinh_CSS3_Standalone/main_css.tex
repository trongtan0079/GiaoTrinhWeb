...
\begin{browserWindow}[Mô Phỏng Trực Quan Kích Thước Chữ Kế Thừa Đa Cấp (16px $\rightarrow$ 20px $\rightarrow$ 16px)]
\sffamily\small
\begin{tcolorbox}[enhanced, colback=white, colframe=primaryBlue!25, arc=6pt, boxrule=0.8pt, top=8pt, bottom=8pt, left=12pt, right=12pt]
  {\fontsize{13pt}{16pt}\selectfont \textcolor{primaryBlue}{\textbf{1. Thẻ <body>: $16\text{px}$ (Kích thước gốc toàn trang)}}\par}
  \vspace{4pt}
  {\fontsize{16pt}{20pt}\selectfont \textcolor{accentPurple}{\textbf{2. Thẻ <div>: $20\text{px}$ ($125\%$ của $16\text{px}$)}}\par}
  \vspace{4pt}
  {\fontsize{13pt}{16pt}\selectfont \textcolor{secondaryTeal}{\textbf{3. Thẻ <p>: $16\text{px}$ ($80\%$ của $20\text{px}$ của thẻ div cha)}}\par}
\end{tcolorbox}
\end{browserWindow}
