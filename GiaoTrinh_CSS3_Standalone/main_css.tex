...
\begin{tcolorbox}[arc=6pt, colback=white, colframe=primaryBlue!30, boxrule=1pt, top=14pt, bottom=14pt, left=10pt, right=10pt]
  ...
  \begin{tikzpicture}[x=1cm, y=1cm, >=stealth]
    % Box 1: 1 line clamp
    \draw[line width=1.2pt, primaryBlue, fill=primaryBlue!5, rounded corners=5pt] (0, 4.4) rectangle (11.2, 6.2);
    \node[anchor=north west, font=\sffamily\small\bfseries\color{primaryBlue}] at (0.3, 6.1) {1. Class .line-clamp (Ẩn sau 1 dòng):};
    \node[anchor=west, font=\sffamily\small\color{darkText}] at (0.4, 5.0) {Đây là nội dung mô tả sản phẩm rất dài, nó sẽ...};

    % Box 2: 2 lines clamp
    \draw[line width=1.2pt, accentOrange, fill=accentOrange!5, rounded corners=5pt] (0, 1.8) rectangle (11.2, 4.0);
    \node[anchor=north west, font=\sffamily\small\bfseries\color{accentOrange!90!black}] at (0.3, 3.9) {2. Class .line-clamp.line-2 (Ẩn sau 2 dòng):};
    \node[anchor=west, font=\sffamily\small\color{darkText}] at (0.4, 3.05) {Dòng 1: Đây là nội dung mô tả sản phẩm rất dài.};
    \node[anchor=west, font=\sffamily\small\color{darkText}] at (0.4, 2.35) {Dòng 2: Nó sẽ bị cắt sau 2 dòng hiển thị...};

    % Box 3: word-break break-all
    \draw[line width=1.2pt, green!60!black, fill=green!5, rounded corners=5pt] (0, -0.8) rectangle (11.2, 1.4);
    \node[anchor=north west, font=\sffamily\small\bfseries\color{green!70!black}] at (0.3, 1.3) {3. Class .break-all (Ngắt từ tự động chống vỡ khung):};
    \node[anchor=west, font=\sffamily\small\color{darkText}] at (0.4, 0.5) {https://example.com/chuoi-url-sieu-sieu-sieu-dai-khong-co-};
    \node[anchor=west, font=\sffamily\small\color{darkText}] at (0.4, -0.2) {khoang-trang-123456789};
  \end{tikzpicture}
\end{tcolorbox}
\end{browserWindow}
