...
Đơn vị \codeinline{em} là một trong những đơn vị tương đối lâu đời và quan trọng nhất trong CSS, bắt nguồn từ thuật ngữ ngành in ấn (chiều rộng của ký tự chữ ``M'' hoa). Trong CSS hiện đại, \codeinline{em} hoạt động linh hoạt theo cơ chế kế thừa ngữ cảnh phông chữ.

\paragraph{1. Quy Tắc Hoạt Động Cốt Lõi Của Đơn Vị em:}
...
\paragraph{2. Cạm Bẫy Cần Tránh: Hiệu Ứng Nhân Dồn Kích Thước (Em Compounding Effect):}
...
\paragraph{3. Ứng Dụng Thực Tế Tuyệt Vời Của em: Nút Bấm Co Giãn Tự Động (Scalable Buttons):}
