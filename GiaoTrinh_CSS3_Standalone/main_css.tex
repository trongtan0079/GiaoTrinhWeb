...
Đơn vị \codeinline{rem} (viết tắt của \term{Root EM}) ra đời để khắc phục triệt để nhược điểm nhân dồn phức tạp của \codeinline{em}. Giá trị của \codeinline{rem} luôn luôn cố định dựa trên \codeinline{font-size} của \textbf{phần tử gốc duy nhất của trang web là thẻ \codeinline{<html>}}.
...
\paragraph{4. Ma Trận So Sánh Toàn Diện: em vs rem}
