...
\sffamily\small
\centering
\begin{tcolorbox}[enhanced, colback=white, colframe=gray!30, width=260pt, height=65pt, arc=6pt, boxrule=1pt, top=6pt, bottom=6pt, left=6pt, right=6pt]
  \begin{tikzpicture}
    % Vị trí gốc (nét đứt)
    \draw[dashed, gray!60, line width=1pt, fill=gray!10, rounded corners=3pt] (0,0) rectangle (2.0, 1.1);
    \node[gray!70, font=\scriptsize\sffamily] at (1.0, 0.55) {Vị trí gốc};
    
    % Mũi tên dịch chuyển
    \draw[-{Stealth[length=4pt]}, accentOrange, line width=1.3pt] (2.1, 0.55) -- (2.9, 0.55) node[midway, above, font=\tiny\sffamily\bfseries\color{accentOrange}] {+50px};
    
    % Vị trí mới sau translateX(50%)
    \draw[primaryBlue, line width=1.1pt, fill=primaryBlue!15, rounded corners=3pt] (1.0,0) rectangle (3.0, 1.1);
    \node[primaryBlue, font=\scriptsize\sffamily\bfseries] at (2.0, 0.55) {translateX(50\%)};
  \end{tikzpicture}
\end{tcolorbox}
\end{browserWindow}
