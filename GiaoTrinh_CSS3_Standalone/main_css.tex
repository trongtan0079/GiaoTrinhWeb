...
% ------------------------------------------------------------------------------
\subsubsection{4. Chuyên Đề Kỹ Thuật Nhúng Nhiều Phông Chữ (Multi-Font Embedding Masterclass)}
...
\begin{enumerate}[leftmargin=1.5em, itemsep=3pt, parsep=0pt]
    ...
    \item \textbf{Kiểm tra hiệu suất với Google Lighthouse}: Đánh giá chỉ số \term{CLS (Cumulative Layout Shift)} và \term{FCP} sau khi nhúng để đảm bảo không bị giật trang.
\end{enumerate}
\end{tipBox}
