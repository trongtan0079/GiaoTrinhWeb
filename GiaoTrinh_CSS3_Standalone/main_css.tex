...
\paragraph{1. Phân Biệt Cốt Lõi: Đơn Vị Phần Trăm (\%) vs Đơn Vị Viewport (vw/vh):}

\begin{codeWindow}[Ví Dụ So Sánh Giữa width: 50\% (Theo Cha) Và width: 50vw (Theo Viewport)]
\begin{lstlisting}[language=HTML5]
<style>
/* Khung cha bi gioi han chieu rong o 300px: */
.narrow-container {
  width: 300px;
  background: #e0e0e0;
  padding: 10px;
...
/* Khoi A: 50% cua khung cha (50% cua 300px = 150px) */
.box-percent {
  width: 50%;
  background: #4caf50;
  color: white;
...
/* Khoi B: 50vw (50% toan bo man hinh trinh duyet, vi du man hinh 1000px -> 500px) */
.box-viewport {
  width: 50vw;
  background: #2196f3;
  color: white;
...
<div class="narrow-container">
  <div class="box-percent">50% (Phu thuoc cha: 150px)</div>
  <div class="box-viewport">50vw (Phu thuoc man hinh: tran khoi cha!)</div>
</div>
\end{lstlisting}
\end{codeWindow}

\begin{browserWindow}[Mô Phỏng Trực Quan Sự Khác Biệt Giữa 50\% Và 50vw Khi Nằm Trong Khung Hẹp]
\sffamily\small
\begin{tcolorbox}[enhanced, colback=gray!15, colframe=gray!40, width=240pt, arc=6pt, boxrule=1pt, top=8pt, bottom=8pt, left=8pt, right=8pt]
  \textcolor{darkText}{\textbf{Khung Hẹp .narrow-container ($240\text{pt}$)}}\par\vspace{5pt}
  % 50% box
  \begin{tcolorbox}[colback=green!70!black, colframe=green!90!black, width=110pt, arc=3pt, boxrule=0.8pt, top=3pt, bottom=3pt, left=6pt, right=6pt]
    \color{white}\bfseries\scriptsize 50\% cha ($110\text{pt}$)
  \end{tcolorbox}
  \vspace{4pt}
  % 50vw box tràn khung
  \begin{tcolorbox}[colback=blue!70!black, colframe=blue!90!black, width=260pt, arc=3pt, boxrule=0.8pt, top=3pt, bottom=3pt, left=6pt, right=6pt]
    \color{white}\bfseries\scriptsize 50vw (Tràn ra ngoài khung cha vì lấy toàn màn hình!)
  \end{tcolorbox}
\end{tcolorbox}
\end{browserWindow}
