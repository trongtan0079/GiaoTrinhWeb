...
\begin{browserWindow}[Kết Quả Hiển Thị: Thang Độ Đậm Trực Quan Từ 100 Đến 900]
\begin{tcolorbox}[arc=4pt, colback=white, colframe=primaryBlue!30, boxrule=0.8pt, top=10pt, bottom=10pt, left=12pt, right=12pt]
  {\sffamily\bfseries\color{primaryBlue} Minh họa độ đậm văn bản trên trình duyệt:}\par\vspace{8pt}
  \begin{tabular}{@{}l l@{}}
    {\sffamily\fontsize{12}{15}\selectfont Chữ rất mỏng (Thin 100)} & {\sffamily\small\color{gray!70} \codeinline{font-weight: 100;}} \\ [3pt]
    {\sffamily\fontsize{12}{15}\selectfont Chữ cực nhẹ (Extra Light 200)} & {\sffamily\small\color{gray!70} \codeinline{font-weight: 200;}} \\ [3pt]
    {\sffamily\fontsize{12}{15}\selectfont Chữ mỏng (Light 300)} & {\sffamily\small\color{gray!70} \codeinline{font-weight: 300;}} \\ [3pt]
    {\sffamily\fontsize{12}{15}\selectfont Chữ bình thường (Normal 400)} & {\sffamily\small\color{gray!70} \codeinline{font-weight: normal;}} \\ [3pt]
    {\sffamily\fontsize{12}{15}\selectfont\textbf{Chữ trung bình (Medium 500)}} & {\sffamily\small\color{gray!70} \codeinline{font-weight: 500;}} \\ [3pt]
    {\sffamily\fontsize{12}{15}\selectfont\textbf{Chữ đậm vừa (Semi Bold 600)}} & {\sffamily\small\color{gray!70} \codeinline{font-weight: 600;}} \\ [3pt]
    {\sffamily\bfseries\fontsize{12}{15}\selectfont Chữ đậm (Bold 700)} & {\sffamily\small\color{gray!70} \codeinline{font-weight: bold;}} \\ [3pt]
    {\sffamily\bfseries\fontsize{12}{15}\selectfont\textbf{Chữ rất đậm (Extra Bold 800)}} & {\sffamily\small\color{gray!70} \codeinline{font-weight: 800;}} \\ [3pt]
    {\sffamily\bfseries\fontsize{12}{15}\selectfont\textbf{Chữ siêu đậm (Black 900)}} & {\sffamily\small\color{gray!70} \codeinline{font-weight: 900;}} \\
  \end{tabular}\par\vspace{6pt}
  {\sffamily\small\color{gray!70} → Áp dụng với phông chữ đa trọng lượng như \codeinline{Roboto} hoặc \codeinline{Inter} để phân biệt rõ từng nấc độ đậm.}
\end{tcolorbox}
\end{browserWindow}
