...
\begin{conceptBox}[Khái Niệm \& Cú Pháp Cơ Bản Của Cursor]
\textbf{Thuộc tính \codeinline{cursor}} trong CSS quy định hình dáng hiển thị của con trỏ chuột khi người dùng di chuyển chuột lên phần tử HTML.
\par\vspace{4pt}
\textbf{Cú pháp cơ bản:}
\begin{lstlisting}[language=CSS3]
selector {
...
\textbf{\codeinline{cursor: pointer;}} là một thuộc tính CSS dùng để thay đổi con trỏ chuột thành biểu tượng bàn tay chỉ khi người dùng đưa chuột vào một phần tử -- biểu thị rằng phần tử đó có thể nhấp được (\term{clickable}).
\par\vspace{4pt}
...
\end{lstlisting}
Khi bạn áp dụng cho một phần tử (ví dụ: nút, liên kết, ảnh...), khi rê chuột vào phần tử đó, con trỏ chuột sẽ biến thành bàn tay -- giống như khi rê vào thẻ \codeinline{<a>}.
\end{conceptBox}
